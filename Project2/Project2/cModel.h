...
public:
	...
	void setRotation(glm::vec3 mdlRotation);
	...
	void initialise(glm::vec3 mdlPosition, glm::vec3 mdlRotation, glm::vec3 mdlScale, glm::vec3 mdlDirection, float mdlSpeed, bool mdlIsActive);
